...
export interface StatsAdvancedStatsforMailboxProvider {
...
export const statsAdvancedStatsforMailboxProviderSchema: Schema<StatsAdvancedStatsforMailboxProvider> = object(
  {
