...
import { Asm2, asm2Schema } from './asm2';
...
import { MailSettings2, mailSettings2Schema } from './mailSettings2';
...
import {
  TrackingSettings2,
  trackingSettings2Schema,
} from './trackingSettings2';
...
export const v3MailSendRequestSchema: Schema<V3MailSendRequest> = object({
  ...
  asm: ['asm', optional(lazy(() => asm2Schema))],
  ipPoolName: ['ip_pool_name', optional(string())],
  mailSettings: ['mail_settings', optional(lazy(() => mailSettings2Schema))],
  trackingSettings: [
    'tracking_settings',
    optional(lazy(() => trackingSettings2Schema)),
  ],
});
